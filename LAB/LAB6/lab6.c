// WAP to enter a 3x3 matrix and display the sum of each row and each column.
#include <stdio.h>
void main()
{
    ...
    printf("\nThe sum of first row is %d", sum_row1);
    printf("\nThe sum of second row is %d", sum_row2);
    printf("\nThe sum of third row is %d", sum_row3);
    printf("\nThe sum of first column is %d", sum_column1);
    printf("\nThe sum of second column is %d", sum_column2);
    printf("\nThe sum of third column is %d", sum_column3);
}